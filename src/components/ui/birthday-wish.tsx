...
export default function BirthdayWish() {
  ...
  return (
    ...
    <div className="min-h-screen bg-pink-300 flex items-center justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black bg-pink-200">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className=" mb-4 text-3xl font-bold text-white bg-gradient-to-br from bg-black rounded-full shadow-lg hover: transform hover:scale-110">Happy  Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-700">Ammar Khan</CardDescription>
            <p className="text-lg text-gray-700">13rth October</p>
          </CardHeader>
